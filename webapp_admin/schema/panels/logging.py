...
PANEL = Panel(
    ...
    sections=(
        Section(
            ...
            fields=(
                Field(
                    "log_channel_id", "ログを送信するチャンネル", Widget.CHANNEL,
                    get=_log_channel, set=set_log_channel,
                    help="未設定にするとログ出力を止めます。",
                ),
                Field(
                    "log_level", "ログレベル", Widget.SELECT,
                    get=_log_level, set=set_log_level,
        ...
        Section(
            ...
            fields=(
                Field(
                    "chatgpt_channel_id", "ChatGPT が応答するチャンネル", Widget.CHANNEL,
                    get=_chatgpt_channel, set=set_response_channel_id,
