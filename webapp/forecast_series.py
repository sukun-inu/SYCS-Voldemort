...
def interval_width_multiplier(
    ...
    *,
    ...
    high, low = (
        FORECAST_INTERVAL_WIDTH_MULTIPLIER,
        FORECAST_INTERVAL_WIDTH_MULTIPLIER_MIN,
    )
    ...
    factor = min(
        max(factor, INTERVAL_COVERAGE_ADJUST_BOUNDS[0]),
        INTERVAL_COVERAGE_ADJUST_BOUNDS[1],
    )
    return base * factor
