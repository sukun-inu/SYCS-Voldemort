const CACHE_NAME = "metal-tracker-v17";
...
const APP_SHELL = [
  ...
  // Bootstrap/Lightweight Chartsは外部CDNではなく自ホストにバンドルしているため、
  ...
  scopedUrl("static/vendor/lightweight-charts/lightweight-charts.standalone.production.js"),
];
